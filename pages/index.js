...
const App = (props) => {
  ...
  const {servicesData, portfolioData, technologiesData, testimonialsData, faqsData} = props;
  return (
    <div>
      <div>
        {/* <Header /> */}
...
export async function getStaticProps(context) {
  const [servicesData, stepsData, portfolioData, technologiesData, testimonialsData, faqsData] = await Promise.all([
    axios.get('http://159.65.156.21:8000/service/list').then(res => res.data),
    axios.get('http://159.65.156.21:8000/stepProcess/list').then(res => res.data),
    axios.get('http://159.65.156.21:8000/portfolio/list').then(res => res.data),
    axios.get("http://159.65.156.21:8000/technology/list").then(res => res.data),
    axios.get("http://159.65.156.21:8000/testimonial/list").then(res => res.data),
    axios.get("http://159.65.156.21:8000/faq/list").then(res => res.data),
  ]);
