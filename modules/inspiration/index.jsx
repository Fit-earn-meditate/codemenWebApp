...
const Inspiration = () => {
  return (
    <section id="inspiration" className="pt-0 pb-20 flex justify-center h-auto lg:h-[500px]">
      <div className="flex flex-col lg:flex-row w-auto lg:w-[1000px] space-y-10 lg:space-x-10">
        ...
        <div className="space-y-8 px-5 lg:px-0 text-center lg:text-left">
          ...
          <div className="text-lg text-[#7E7E7E]">
            At Code Banana, we're more than just a digital company. We're a community of enthusiasts who are passionate about innovation and growth. We're here to partner with local businesses and startups on their digital journeys, to illuminate the path, and to celebrate every achievement.
            Together, we'll continue to push boundaries and pave the way for a brighter digital future.
          </div>
          <div>
            <h4 className="text-[#7E7E7E] text-xl font-semibold">Archita Moitra</h4>
